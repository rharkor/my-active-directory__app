...
export const getColumns: (
  handleResetToken: (id: number) => Promise<void>,
) => (
...
>[] =
  (handleResetToken) => (showEditServiceAccountModal, deleteServiceAccount) => [
    {
      accessorKey: 'id',
      header: 'Id',
    },
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                onClick={() =>
                  navigator.clipboard.writeText(serviceAccount.name)
                }
              >
                Copy name
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem
                onClick={() => handleResetToken(serviceAccount.id)}
              >
                Reset token
              </DropdownMenuItem>
              <DropdownMenuItem
              ...
              <DropdownMenuItem
                onClick={deleteServiceAccount(serviceAccount.id)}
              >
                Delete
              </DropdownMenuItem>
            </DropdownMenuContent>
